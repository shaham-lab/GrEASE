...
class GrEASE:
    def __init__(
            ...
            should_return_first_eigenvector: bool = False,
            t: int = 0,
        ...
        should_return_first_eigenvector : bool, optional (default=False)
            Specifies whether to return the first eigenvector of the Laplacian of the input data.
        ...
        if t > 0:
            ...
            self.should_return_first_eigenvector = False
        else:
            self.should_true_eigenvectors = should_true_eigenvectors
            self.should_return_first_eigenvector = should_return_first_eigenvector
    ...
    def transform(self, X: torch.Tensor) -> np.ndarray:
        ...
        if self.should_return_first_eigenvector:
            return self._predict(X) @ self.ortho_matrix
